...
ticker = 'X:INJWAVESUSD'
tiker_live = 'INJWAVES/USD'
#----- initialistion de l'API key et ticker -----#
...
#
                ...
                Write.Print("INJWAVES  ", Colors.green, interval=0.000)
                ...
                if (C - B) < (C - D) and (C - B) < (E - D) and (E - F) < (E - D) and (E - F) < (C - D) and B > D and F > D and B < C and F < E and A >= mirande2['c'].iloc[0] and verif == 0 and ordre == True and mini_pourcent == True:
                        ...
                        if I[1] > B and J[1] > F and moyenne_epaule1 <= moyenne_tete / 2 and moyenne_epaule2 <= moyenne_tete / 2 and moyenne_epaule1 >= moyenne_tete / 4 and moyenne_epaule2 >= moyenne_tete / 4 and accept == True and df['c'].values[-2] <= J[1] + (moyenne_tete) / 4 and df['c'].values[-2] >= J[1]  and df['c'].values[-1] <= J[1] + (moyenne_tete) / 4 and df['c'].values[-1] >= J[1]:
                                ...
                                plt.plot([], [], ' ')
                                plt.title(f'IETE : {tiker_live} | {time1} {time_name1} | {pourcent_chercher}',
                                ...
                                plt.text(local_max[-2], C, "C", ha='left', style='normal', size=10.5, color='red',
                                         wrap=True)
                                plt.text(local_min[-2], D, "D", ha='left', style='normal', size=10.5, color='red',
                                         wrap=True)
                                ...
                                plt.text(place_liveprice, G, f"G  {round(G, 5)}", ha='left', style='normal', size=10.5,
                                         color='red', wrap=True)
                                plt.text(I[0], I[1], "I", ha='left', style='normal', size=10.5, color='#00FF36',
                                         wrap=True)
